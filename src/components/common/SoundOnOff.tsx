...
function SoundOnOff() {
    ...
    return (
        <div className="sound-onoff">
            <StyledButton className={`btn-sound`} color={"#FFF"} onClick={onClickBtn}>
                {
                    isSoundOn ?
                        <svg version="1.1" id="레이어_1" x="0px" y="0px" height="2rem" fill="white" viewBox="0 0 96 96">
                        ...
                        <svg version="1.1" id="레이어_1" x="0px" y="0px" height="2rem" fill="white" viewBox="0 0 96 96" >
                            ...
                            <g>
                                <g>
                                    <path d="M89.7,7.8c-32,32-48.4,48.4-80.4,80.4" stroke="white" />
