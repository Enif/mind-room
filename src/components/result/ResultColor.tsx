...
import grafolio from '../../assets/icons/grafolio.svg';
        ...
        <>
            {
                result ?
                    <StyledDiv className="result-wrp" backgroundColor={result.backgroundColor}>
                        ...
                        <div className="result-middle">
                            <StyledSvg fill={result.replayIconColor} height="2.5rem" xmlns="http://www.w3.org/2000/svg" version="1.1" id="레이어_1" x="0px" y="0px" viewBox="0 0 96 96" >
